...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <!-- <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand js-scroll-trigger" href="#masthead"><img src="assets/img/navbar-logo-stmargaret.png" alt=""/></a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ml-auto">
                        ...
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#our-people">Our People</a></li>
        ...
        <!-- Masthead-->
         <header class="masthead">
            <div class="container"> 
                ...
                <br>
                <a class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" href="{{route('landing_main.index')}}">Find out more...</a> 
