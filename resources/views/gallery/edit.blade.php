...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <h2 class="m-0 font-weight-bold text-info">Update Image</h2>
</div>
...
<form action="{{ route('gallery.update', $gallery->id) }}" method="post" enctype="multipart/form-data">
    ...
    <div class="col-xs-3 col-sm-3 col-md-4">
        <div class="form-group">
            ...
            <input type="date" name="gallery_date" id="gallery_date" class="form-control" placeholder="" autocomplete="off" value="{{ $gallery->gallery_date }}">
        </div>
    </div>
        ...
        <div class="form-group">
            ...
            <textarea class="form-control"  name="gallery_description" id="gallery_description" autocomplete="off" rows="5">{{ $gallery->gallery_description }}</textarea>
        </div>

            <div class="row">
                <div class="form-group">
                    <div class="col-xs-3 col-sm-3 col-md-4">
                         <input id="uploadImage" type="file" name="gallery_image" accept="image/*" capture="camera" value="{{ $gallery->gallery_image }}"/>     
                    </div>
                </div>
            </div>
    ...
    <button class="btn btn-primary btn-sm" type="submit">Update Image</button>
</form>
